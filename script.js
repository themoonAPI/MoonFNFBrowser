...
mods.forEach(mod => {
    ...
    card.innerHTML = `<img src="${mod.thumb || 'https://via.placeholder.com/200x150/222/FFF?text=No+Thumb'}"><p>${mod.name}</p>`;
    card.onclick = () => {
...
document.getElementById('fullscreen-btn').onclick = () => {
    document.getElementById('mod-player').requestFullscreen();
};
